...
│   │   ├── ProductManagement.jsx # Katalog produk, Merek, Kategori & Pengajuan Inventaris
│   │   ├── ScannerModal.jsx    # Modal pemindai QR / Barcode via kamera live
│   │   ├── Sidebar.jsx         # Bilah navigasi samping (Desktop)
│   │   ├── StockIn.jsx         # Alur Barang Masuk, Konfirmasi Surat Jalan & Request Stok
│   │   ├── StockOut.jsx        # Alur Barang Keluar, Kasir POS & Transfer Cabang
